...
2. ISM _[ Inverse spectrogram method ]_
...
> **Note:**
> Current max image size is 1e10 ( =  _10 000 000 000_ )
> .{image} with **width** x **height** > 1e10 will be skipped.
...
> Files with hash mismatches or unsupported scan modes (such as spiral) will be skipped.
